-- Repair admin_customer_spend view: ensure phone column is present and grants are correct.
-- This is a re-apply of 20260703153000 in case the remote database missed that migration.
